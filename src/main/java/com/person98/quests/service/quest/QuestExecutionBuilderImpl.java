                  ...
                  if (stage.isFinished(data)) {
                     ...
                     if (!quest.isStory()) {
                        ...
                        if (!today.equals(user.getLastDailyRewardDate())) {
                           List<Quest> allDailies = Quests.getInstance().getQuestController().getDailyQuests();
                           ...
                           if (allComplete) {
                              Quests.getInstance().executeRewardCommands(this.player.getName());
                     ...
                     if (position != -1 && quest.getStages().size() > position + 1) {
                        ...
                        if (next != null) {
                           ...
                           if (isDaily) {
                              ...
                              Quests.getInstance().getStorage().saveUser(user);
                           }
